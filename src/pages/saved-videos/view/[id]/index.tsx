...
import { getSavedVideoById } from 'apiSdk/saved-videos';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Saved Video Detail View
          </Text>
          {hasAccess('saved_video', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/saved-videos/edit/${data?.id}`} passHref legacyBehavior>
              <Button
